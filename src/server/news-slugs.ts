// SSR-only mapping: WordPress news canonical (FR) slug -> EN slug used in /en routes.
// Falls back to the canonical slug when no explicit EN mapping exists.
...
export function toNewsEnSlug(canonicalSlug: string): string {
